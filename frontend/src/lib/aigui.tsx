...
/**
 * Re-exported so the chat renderer keeps one import for everything AIGUI needs.
 * It lives in lib/blocks because the avatar page needs it too and must not pull
 * in the App bindings this module is wired to.
 */
export { normalizeOneLineBlocks } from "./blocks";
